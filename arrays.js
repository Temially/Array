/*arra */
		...
		function colorful(colors, o){
			for(i=0; i<colors.length; i++){
				i<3? console.log(`${i+1}${o[i+1]} choice is ${colors[i]}.`) : console.log(`${i+1}${o[0]} choice is ${colors[i]}.`);
			}
		}
		...
		function joinElements(myColors){
			 return (myColors.join()+"\n").repeat(2)+myColors.join('+')
		}
...
console.log("Employees who are web developers: ", employees.filter(employee =>employee.Job === 'Web Developer'))
console.log("Employees that are both web developers and are from Nigeria: ", employees.filter(employee =>employee.Job === 'Web Developer' && employee.Country === 'Nigeria'))
console.log("Employees that are below 20: ", employees.filter(employee =>employee.age < 20))
console.log("Employees that are active: ", employees.filter(employee =>employee.active === true))
